...
public class InventoryManager : MonoBehaviour
{
    ...
    {
        GameObject newItemGo = Instantiate(itemInventoryPrefab, slot.transform);
        InventoryItem ýnventoryItem = newItemGo.GetComponent<InventoryItem>();
        ýnventoryItem.InitialiseItem(item);
    }
